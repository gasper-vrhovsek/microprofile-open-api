...
import org.eclipse.microprofile.asyncapi.models.bindings.channel.AmqpBindings;
import org.eclipse.microprofile.asyncapi.models.bindings.channel.WebsocketsBindings;
 ...
 */
public interface ChannelBindings extends Constructible, Extensible<ChannelBindings>, Reference<ChannelBindings> {
     ...
     */
    void setWs(WebsocketsBindings ws);
     ...
     */
    void setMqtt(EmptyBindings mqtt);
