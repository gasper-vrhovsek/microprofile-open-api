...
import org.eclipse.microprofile.asyncapi.models.bindings.message.AmqpBindings;
import org.eclipse.microprofile.asyncapi.models.bindings.message.HttpBindings;
import org.eclipse.microprofile.asyncapi.models.bindings.message.KafkaBindings;
import org.eclipse.microprofile.asyncapi.models.bindings.message.MqttBindings;
 ...
 */
public interface MessageBindings extends Constructible, Extensible<MessageBindings>, Reference<MessageBindings> {
     ...
     */
    void setHttp(HttpBindings http);
     ...
     */
    void setKafka(KafkaBindings kafka);
     ...
     */
    void setAmqp(AmqpBindings amqp);
