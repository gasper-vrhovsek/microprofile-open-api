...
public @interface AmqpBindings {
    ...
    /**
     * Property similar to {@link org.eclipse.microprofile.asyncapi.models.bindings.operation.AmqpBindings#getCc} but consumers will not receive this information.
     *
     * @return bcc property
     * */
    String[] bcc() default {};
